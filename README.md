...
When building stateful class components, one should should create state within the class component itself. It should also be managed, optimally with lifecycle methods.

2. Describe the different phases of the component lifecycle.

The initial phase is the render method. Once it successfully renders, the componentDidMount method is called. with any update within the component, the componentDidUpdate method is colled, and when the component is no longer mounted, the componentDidUnmount is called.

3. Demonstrate an understanding of class component lifecycle methods.

Looking at my code, specifically the PlantList, one will see methods like componentDidMount and componentDidUpdate are called.

4. Define stateful logic.

Stateful logic is the manegment of state. A seperate component is capable of handling state and how it is updated.

5. Describe how to test a React component with React Testing Library.

With testing libraries like Jest, one can use a cli to run automated test. This gives one the ability to run test during development and when someone know looks at the project, it gives them a blueprint of how the component should function.
